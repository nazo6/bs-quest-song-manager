...
async configGet() : Promise<__Result__<{ connection: Connection | null }, string>> {
try {
...
async configSetConnection(connectionConfig: Connection) : Promise<__Result__<null, string>> {
try {
...
export type Connection = { root: ModRoot; conn_type: ConnectionType }
